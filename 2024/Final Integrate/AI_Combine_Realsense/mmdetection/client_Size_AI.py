...
CLIENT_UPLOAD_FOLDER = 'client_size_ai'
...
def process_files(image_filename, depth_filename):
    with processing_lock:
        ...
        try:
            ...
            SizeFinalMeasurement.main(config_file, checkpoint_file, image_path, depth_path, output_path)
